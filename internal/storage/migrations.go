...
func RunMigrations() error {
	...
	if err := MigrateUsersRemoveDigestSettings(); err != nil {
		fmt.Printf("migration: MigrateUsersRemoveDigestSettings failed: %v\n", err)
		errCount++
	}
	...
	if err := MigrateProjectsAddBacklogName(); err != nil {
	...
	if err := MigrateProjectStatusesAddDescription(); err != nil {
		fmt.Printf("migration: MigrateProjectStatusesAddDescription failed: %v\n", err)
		errCount++
	}
	...
	if err := MigrateProjectSprintsAddDescription(); err != nil {
